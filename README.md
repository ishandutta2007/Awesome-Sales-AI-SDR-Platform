<p align="center">
  <img src="assets/banner.svg" alt="Awesome Sales AI SDR Platforms &amp; Autonomous Outbound Agents" width="100%">
</p>
...
flowchart LR
    A["🎯 Signal Trigger
(Hiring / Funding / Webhook)"] --> B["🔍 Deep Research
(GPT Researcher / Firecrawl)"]
    B --> C["🧩 Enrichment Layer
(Waterfall / Composio / CRM)"]
    C --> D["🤖 LLM Agent Pipeline
(CrewAI / LangGraph / Claude)"]
    D --> E["🛡️ Human-in-the-Loop
(Approval & Review)"]
...
[![Star History Chart](https://star-history.dera.page/svg?repos=ishandutta2007/Awesome-Sales-AI-SDR-Platform&type=date&legend=top-left)](https://star-history.dera.page/#ishandutta2007/Awesome-Sales-AI-SDR-Platform&type=date&legend=top-left)
...
<p align="center">
  <sub>Built with ❤️ for sales leaders, GTM engineers, and AI developers.</sub>
</p>
